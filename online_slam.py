# Function 'online_slam' takes 5 inputs:
# data, N, num_landmarks, motion_noise and measurement_noise
#
# Returns - TWO matrices, mu and the final Omega.
#
# Have x and y interlaced, so if there were two poses and 2
...
# Uncomment the following three lines to run the full slam for random data
#
# data = make_data(N, num_landmarks, world_size, measurement_range, motion_noise, measurement_noise, distance)
# result = slam(data, N, num_landmarks, motion_noise, measurement_noise)
# print_result(N, num_landmarks, result)

# Uncomment the following three lines to run the online_slam  for random data
#
# data = make_data(N, num_landmarks, world_size, measurement_range, motion_noise, measurement_noise, distance)
